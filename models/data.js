var packages = {
  ...
  init() {
    ...
    this.fakeDB.push({
      ...
      WhatIsIncluded:
        "Beef, Eggplant, Garlic, Green chili pepper, Carrot, Onion",
      price: "$11.95",
      desc:
    ...
    this.fakeDB.push({
      ...
      WhatIsIncluded: "Buckwheat noodle, Korean radish, Scallion, Wassabi",
      price: "$9.95",
      desc:
      ...
      categoryBoolen: false,
      servings: "1",
      caloriesPerServing: "751",
      IsItaTopMeal: false,
    })
